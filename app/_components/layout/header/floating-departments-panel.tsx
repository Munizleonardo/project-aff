...
export function FloatingDepartmentsPanel({ departments, open, onToggle }: { departments: Category[]; open: boolean; onToggle: () => void }) {
  return (
    <div className="relative">
      ...
      {open ? (
        <div className="floating-nav-panel absolute right-full top-0 mr-3 w-[340px] rounded-2xl border border-slate-700/70 bg-[#07101f]/95 p-3 shadow-2xl shadow-black/40 backdrop-blur-xl">
            ...
            {departments.map((department) => {
              ...
              return (
                <Link
                  ...
                  className="floating-department-link flex items-center gap-3 rounded-xl border border-white/5 bg-white/[0.03] p-3 transition hover:border-cyan-300/40 hover:bg-white hover:text-slate-950"
                >
