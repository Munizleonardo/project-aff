...
export function SearchBar({ compact = false }: { compact?: boolean }) {
  return (
    <form className={`flex items-center gap-3 rounded-full border border-slate-700/80 bg-slate-950/80 px-4 text-white shadow-inner shadow-black/20 backdrop-blur ${compact ? "h-11 w-full" : "h-11 w-full max-w-[580px]"}`}>
